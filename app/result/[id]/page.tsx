  ...
  return (
    <div className="mx-auto flex h-dvh w-full max-w-sm md:max-w-lg flex-col">
      ...
      <div className="flex flex-1 flex-col items-center gap-4 overflow-y-auto p-6 text-center">
        ...
        <div className="flex w-full max-w-sm md:max-w-lg gap-3">
        ...
        <div className="w-full max-w-sm md:max-w-lg rounded-xl border border-[#3d3020] bg-[#221c0e] p-4 text-left">
      ...
      <div className="mx-auto flex w-full max-w-sm md:max-w-lg shrink-0 flex-col gap-3 p-4">
        <Link
